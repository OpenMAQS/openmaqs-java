...
import com.maqs.utilities.logging.*;
...
public class BaseTestUnitTest extends BaseTest {
  ...
  public void fullyQualifiedTestNameTest() {
    ...
    Assert.assertEquals(testName,
        "com.maqs.base.BaseTestUnitTest.fullyQualifiedTestNameTest");
  }
   ...
   * (non-Javadoc)
   *
   * @see com.maqs.utilities.BaseTest.BaseTest#beforeLoggingTeardown(org.testng.
   * ITestResult)
   */
  @Override
