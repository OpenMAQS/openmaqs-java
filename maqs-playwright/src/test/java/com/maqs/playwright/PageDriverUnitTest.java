...
import com.maqs.playwright.pageModel.ElementPageModel;
import com.maqs.playwright.pageModel.PageModel;
...
public class PageDriverUnitTest extends BasePlaywrightTest {
  ...
  public void contentTest() {
    Assert.assertTrue(this.getPageDriver().content().contains("MAQS Framework"));
  }
  ...
  public void innerHTMLTest() {
    Assert.assertTrue(this.getPageDriver().innerHTML(elementPageModel.footer).contains("MAQS Framework"));
  }
  ...
  public void innerTextTest() {
    Assert.assertTrue(this.getPageDriver().innerText(elementPageModel.footer).contains("MAQS Framework"));
  }
