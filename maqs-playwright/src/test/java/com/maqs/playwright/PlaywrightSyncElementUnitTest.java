...
import com.maqs.playwright.pageModel.IFramePageModel;
...
public class PlaywrightSyncElementUnitTest extends BasePlaywrightTest {
  ...
  public void innerHTMLTest() {
    createPlaywrightPageModel();
    Assert.assertTrue(models.get(this.getTestObject()).getFooter().innerHTML().contains("MAQS Framework"));
  }
  ...
  public void innerTextTest() {
    createPlaywrightPageModel();
    Assert.assertTrue(models.get(this.getTestObject()).getFooter().innerText().contains("MAQS Framework"));
  }
