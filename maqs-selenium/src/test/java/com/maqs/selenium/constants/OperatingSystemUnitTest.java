...
package com.maqs.selenium.constants;
...
public class OperatingSystemUnitTest extends BaseGenericTest {
  ...
  @Test(singleThreaded = true,
        dependsOnMethods = "com.maqs.selenium.constants.OperatingSystemUnitTest.testGetOperatingSystemMacOS")
   ...
   */
  @Test(singleThreaded = true,
        dependsOnMethods = "com.maqs.selenium.constants.OperatingSystemUnitTest.testGetOperatingSystemLinux")
