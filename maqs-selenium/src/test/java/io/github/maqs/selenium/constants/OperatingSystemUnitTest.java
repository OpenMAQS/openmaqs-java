...
public class OperatingSystemUnitTest extends BaseGenericTest {
  ...
  @Test(singleThreaded = true,
        dependsOnMethods = "io.github.maqs.selenium.constants.OperatingSystemUnitTest.testGetOperatingSystemMacOS")
   ...
   */
  @Test(singleThreaded = true,
        dependsOnMethods = "io.github.maqs.selenium.constants.OperatingSystemUnitTest.testGetOperatingSystemLinux")
