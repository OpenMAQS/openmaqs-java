...
import io.github.openmaqs.utilities.logging.*;
...
public class BaseTestUnitTest extends BaseTest {
  ...
  public void fullyQualifiedTestNameTest() {
    ...
    Assert.assertEquals(testName,
        "io.github.openmaqs.base.BaseTestUnitTest.fullyQualifiedTestNameTest");
  }
   ...
   * (non-Javadoc)
   *
   * @see io.github.openmaqs.utilities.BaseTest.BaseTest#beforeLoggingTeardown(org.testng.
   * ITestResult)
   */
  @Override
